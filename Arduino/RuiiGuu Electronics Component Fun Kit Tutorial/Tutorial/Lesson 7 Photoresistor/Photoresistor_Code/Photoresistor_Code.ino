...
int clockPin = 12;//Pin 11 (SRCLK) of the shift register to pin 12 on the Arduino – this will be referred to as the“clock pin”
int dataPin = 9;//Pin 14 (SER) of the shift register to pin 9 on the Arduino – this will be referred to as the “data pin”
